...
public class AccountsPage {
	...
	public String getAccPageTitle() {
		return eleUtil.waitForTiltleIs(AppConstants.ACCOUNTS_PAGE_TITLE, AppConstants.SHORT_TIME_OUT);
	}
	...
	public List<String> getAccountsPageHeader() {
		List<WebElement> headersList = eleUtil.waitForElementsVisible(accHeader, AppConstants.MEDIUM_TIME_OUT);
	...
	public int getAccountsPageHeaderCount() {
		 return eleUtil.waitForElementsVisible(accHeader, AppConstants.MEDIUM_TIME_OUT).size();
	}
